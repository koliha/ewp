...
def main() -> int:
    ...
    steps = [
        ...
        [sys.executable, "tests/test_mem0_client.py"],
        [sys.executable, "tests/test_mcp.py"],
        [sys.executable, "tests/test_mcp_fuzz.py"],
        [sys.executable, "tests/test_transport_fuzz.py"],
        [sys.executable, "tests/test_parity_fuzz.py"],
        [sys.executable, "tests/test_store_fuzz.py"],
