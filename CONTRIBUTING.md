...
| Missing ugly case | Add a fixture to the hardening pack (`ewp/laundering.py`). If it needs a new judgment, that is a policy change. |
...
- Do not change `ewp/classify.py` / `ewp/warrant.py` without regenerating goldens *and* changing the policy or protocol version.
